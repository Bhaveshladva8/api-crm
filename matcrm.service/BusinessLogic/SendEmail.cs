...
namespace matcrm.service.BusinessLogic
{
    public class SendEmail
    {
        ...
        public async Task SendEmailEmployeeTaskUserAssignNotification(string email, string receiverName, string taskname, long? tenantId)
        {
        ...
        public async Task SendEmailEmployeeProjectUserAssignNotification(string email, string receiverName, string projectname, long? tenantId)
        {
            var subject = "Employee" + " - Project Assigned";
            // var body = _emailTemplateService.GetEmailTemplateByCode ("EVERN").TemplateHtml;
            var body = "<div style='border:1px solid #dedede;box-shadow: 0px 0px 5px #dddddd;padding:10px;'> <p>Dear [@ToName],<br />  [@projectname]  assigned to you. </p> <p><br />  Regards,</p> <p>[@CompanyName]</p> <p>THIS IS AN AUTOMATED EMAIL, PLEASE DO NOT REPLY</p>  </div>";
            //var body = taskname + " Assigned to you.";
