...
{
    public class ServiceArticleService : Service<ServiceArticle>, IServiceArticleService
    {
        ...
        {
            return _unitOfWork.ServiceArticleRepository.GetMany(t => t.TenantId == tenantId && t.DeletedOn == null).Result.Include(t => t.ServiceArticleCategory).Include(t => t.Currency).ToList();
        }
