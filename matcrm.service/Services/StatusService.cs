...
namespace matcrm.service.Services
{
    public partial class StatusService : Service<Status>, IStatusService
    {
        ...
        public List<Status> GetByCustomTableName (long customtableId) {
            return _unitOfWork.StatusRepository.GetMany (t => t.IsDeleted == false && t.CustomTableId == customtableId).Result.ToList();            
        }
    ...
    public partial interface IStatusService : IService<Status> {
        ...
        List<Status> GetByCustomTableName(long customtableId);
    }
}