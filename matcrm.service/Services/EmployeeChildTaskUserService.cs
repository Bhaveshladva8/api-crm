...
namespace matcrm.service.Services
{
    public partial class EmployeeChildTaskUserService : Service<EmployeeChildTaskUser>, IEmployeeChildTaskUserService
    {
        ...
        public EmployeeChildTaskUser CheckInsertOrUpdate(EmployeeChildTaskUserDto model)
        {
            ...
            {
                return InsertChildTaskUser(employeeChildTaskUserObj);
            }
            else
            {
                return existingItem;
        ...
        public EmployeeChildTaskUser InsertChildTaskUser(EmployeeChildTaskUser employeeChildTaskUserObj)
        {
            employeeChildTaskUserObj.CreatedOn = DateTime.UtcNow;
            var newItem = _unitOfWork.EmployeeChildTaskUserRepository.Add(employeeChildTaskUserObj);
    ...
    {
        EmployeeChildTaskUser CheckInsertOrUpdate(EmployeeChildTaskUserDto model);
